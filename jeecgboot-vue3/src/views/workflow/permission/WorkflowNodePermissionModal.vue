    ...
    <div class="pt-3px pr-3px">
      ...
      <div v-if="showFieldPermissions" class="field-permissions-section">
        ...
        >
          ...
          <template #toolbar>
            <a-space>
              <a-button @click="batchSetPermission('editable')" size="small"> 批量设为可编辑 </a-button>
              <a-button @click="batchSetPermission('readonly')" size="small"> 批量设为只读 </a-button>
              <a-button @click="batchSetPermission('hidden')" size="small"> 批量设为隐藏 </a-button>
            </a-space>
          </template>
        </JVxeTable>
      </div>
